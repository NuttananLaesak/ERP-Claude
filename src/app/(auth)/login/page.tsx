...
function GlowButton({ pending }: { pending: boolean }) {
  ...
  return (
    <button
      ...
      style={{
        background:
          "linear-gradient(135deg, #5b21b6 0%, #7c3aed 40%, #0e7490 100%)",
        boxShadow:
          "0 0 0 1px rgba(139,92,246,.35), 0 8px 32px rgba(124,58,237,.55), 0 2px 8px rgba(6,182,212,.25), inset 0 1px 0 rgba(255,255,255,.12)",
      }}
    >
      <span
        ...
        style={{
          background:
            "linear-gradient(135deg, #7c3aed 0%, #a855f7 45%, #06b6d4 100%)",
        }}
      />
      <span
        ...
        >
          <div
            ...
            style={{
              ...
              background:
                "conic-gradient(from 0deg, #5b21b6, #7c3aed, #a855f7, #ec4899, #06b6d4, #3b82f6, #5b21b6)",
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, rgba(12,8,32,.97) 0%, rgba(6,4,20,.98) 100%)",
              boxShadow:
                "inset 0 1px 0 rgba(139,92,246,.14), inset 0 -1px 0 rgba(6,182,212,.07)",
            }}
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, rgba(124,58,237,.4), rgba(6,182,212,.3), transparent)",
              }}
            />
            ...
            >
              <h1 className="text-[2rem] font-bold tracking-tight leading-tight">
                ...
                <span
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(135deg, #a78bfa 0%, #67e8f9 55%, #f0abfc 100%)",
                  }}
                >
                  back
                </span>
            ...
            <form action={action} className="space-y-5">
              <div className="input-group" style={S.email}>
                ...
                />
                <label htmlFor="login-email" style={{ left: "2.5rem" }}>
                  Email address
                </label>
              </div>
              ...
              <div className="input-group" style={S.password}>
                ...
                />
                <label htmlFor="login-password" style={{ left: "2.5rem" }}>
                  Password
                </label>
                <button
                  type="button"
